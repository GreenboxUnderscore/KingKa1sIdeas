...
public enum KingKa1sToolMaterial implements ToolMaterial {
    ...
    EMERALD(3, 1561, 8.0F, 3.0F, 10, () -> Ingredient.ofItems(Items.EMERALD)),
    GOLD(0, 32, 12.0F, 0.0F, 22, () -> Ingredient.ofItems(Items.GOLD_INGOT)),
    OBSIDIAN(3, 2031, 12.0F, 4.0F, 30, () -> Ingredient.ofItems(Items.OBSIDIAN)),
    NETHERITE(4, 2031, 9.0F, 4.0F, 15, () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),
    SHADOW(4, 4062, 12.0F, 4.0F, 30, () -> Ingredient.ofItems(KingKa1sItems.SHADOW_INGOT));
