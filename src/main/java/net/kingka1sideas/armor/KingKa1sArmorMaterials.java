...
public enum KingKa1sArmorMaterials implements ArmorMaterial {
    ...
    OBSIDIAN("obsidian", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ENTITY_GENERIC_EXTINGUISH_FIRE, 2.0F, 0.0F, () -> Ingredient.ofItems(Items.OBSIDIAN)),
    ...
    SHADOW("shadow", 37, new int[]{3, 6, 8, 3}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 3.0F, 0.1F, () -> Ingredient.ofItems(KingKa1sItems.SHADOW_INGOT));
    ...
    KingKa1sArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier repairIngredientSupplier) {
        this.name = name;
